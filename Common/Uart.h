...
extern int8_t Uart1_Init(int Rate);
 ...
 * @author Adam Korycki, 2023.11.02 */
extern int8_t Uart1_rx(uint8_t* data, uint16_t size);
 ...
 * @author Adam Korycki, 2023.11.02 */
extern int8_t Uart1_tx(uint8_t* data, uint16_t size);
 ...
 * @author Adam Korycki, 2023.11.02 */
extern int8_t Uart6_Init(int Rate);    
 ...
 * @author Adam Korycki, 2023.11.02 */
extern int8_t Uart6_rx(uint8_t* data, uint16_t size);
 ...
 * @author Adam Korycki, 2023.11.02 */
extern int8_t Uart6_tx(uint8_t* data, uint16_t size);
